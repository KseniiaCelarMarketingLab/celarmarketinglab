...
export default async function handler(req, res) {
  ...
  const accessUrl = 'https://celarmarketinglab.com/course?token=' + token;
...
<body><div class="wrap">
  ...
  <div class="body-text">Your access to <strong style="color:#F5F5F5">SMM Without Budget — 30-Day Challenge</strong> is ready. Click below to open your personal challenge platform.</div>
  <a class="cta" href="${accessUrl}">Open My Challenge →</a>
  <div class="url-box">Or copy this link:<br><a href="${accessUrl}">${accessUrl}</a></div>
  <div class="warning"><strong style="color:#ED3E61">Important:</strong> This link is personal — bookmark it to return to your progress anytime.</div>
  <div class="divider"></div>
  <div class="footer">
    Questions? Write to <a href="mailto:kseniia@celarlab.com">kseniia@celarlab.com</a><br>
    3-day money-back guarantee — no questions asked.<br><br>
